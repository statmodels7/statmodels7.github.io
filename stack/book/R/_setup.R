...
suppressMessages({
  ...
  pkgload::load_all(file.path(.toolkit_root, "modelterms7"), quiet = TRUE, export_all = FALSE)
  pkgload::load_all(file.path(.toolkit_root, "statmodels7"), quiet = TRUE, export_all = FALSE)
})
