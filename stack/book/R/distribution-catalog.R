...
DISTRIBS$enet <- list(
  ...
  curves = list(mu = c(-2, 0.3, 2.5),
                lambda = c(0.5, 1.5, 4),
                alpha = c(0.02, 0.6, 0.98)),
  support = "y \\in \\mathbb{R}",
