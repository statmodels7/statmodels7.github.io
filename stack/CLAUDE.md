...
| `modelterms7` | 96 tests, `R CMD check --as-cran` clean apart from the environment notes and the local-only `Remotes` warning, phases 1-2 done 2026-08-08 (`piano_modelterms7.txt`). Version `0.2.0`, `NEWS.md` from the first commit. Repo pushed; CI, pkgdown and Pages arrive with phase 5 |
